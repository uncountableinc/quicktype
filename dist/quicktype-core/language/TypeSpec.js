...
exports.typespecOptions = {
    features: new RendererOptions_1.EnumOption("type-spec-version", "TypeSpec version", [
...
class TypeSpecTargetLanguage extends TargetLanguage_1.TargetLanguage {
    getOptions() {
        return [exports.typespecOptions.features, exports.typespecOptions.justTypes, exports.typespecOptions.nicePropertyNames];
    }
    ...
    makeRenderer(renderContext, untypedOptionValues) {
        const options = RendererOptions_1.getOptionValues(exports.typespecOptions, untypedOptionValues);
...
exports.TypeSpecTargetLanguage = TypeSpecTargetLanguage;
...
class TypeSpecRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
...
exports.TypeSpecRenderer = TypeSpecRenderer;
...
class JSONTypeSpecRenderer extends TypeSpecRenderer {
    constructor() {
        super(...arguments);
    ...
    emitClosingCode() {
        this.forEachTopLevel(["interposing", 2], (t, name) => {
            ...
            this.emitBlock(["def ", fromDict, "(", this.typingDecl("s", "Any"), ")", this.typeHint(" -> ", typespecType), ":"], () => {
                this.emitLine("return ", makeValue(this.deserializer({ value: "s" }, t)));
            });
            this.ensureBlankLine(2);
            this.emitBlock(["def ", toDict, "(x", this.typeHint(": ", typespecType), ")", this.typingReturn("Any"), ":"], () => {
                this.emitLine("return ", makeValue(this.serializer({ value: "x" }, t)));
            });
        });
    }
}
exports.JSONTypeSpecRenderer = JSONTypeSpecRenderer;
